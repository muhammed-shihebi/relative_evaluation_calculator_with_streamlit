...
my_grade = st.number_input('Your score (real or estimate)', min_value=0.0, max_value=100.0, value=90.0, step=1.0)
m = st.number_input('Average score of your class (real or estimate)', min_value=0.0, max_value=100.0, value=50.0, step=1.0)
...
st.metric(label="Your letter score", value=calc.cal_letter(my_grade, m, s, t))
